        ...
        <b-row class="justify-content-center">
            <b-col  col lg="4" md="auto">
                <b-card >
                    ...
                    <b-form class="mt-4" @submit="onSubmit" @reset="onReset" v-if="show">
                    <b-form-group
                        id="input-group-1"
                    ...
                    <b-form-group id="input-group-2" label="Senha:" label-for="input-2" autofocus="true">
                        <b-form-input
                        id="input-3" type="password"
                        v-model="form.password"
                        placeholder="Senha"
                        required
                        ></b-form-input>
                    </b-form-group>
                    <b-form-group id="input-group-3" label="" label-for="input-2" autofocus="true">
                        <b-form-input
                        id="input-4" type="password"
                    ...
                    <b-button class="mr-5" type="submit" variant="primary">Cadastrar</b-button>
